 ...
 * - MALEEHA in Rubik Scribble font (splits into letters during scroll)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for MALEEHA split effect
    const letters = useMemo(() => [
        { char: 'M', baseX: -1.5, splitDir: -2.0, delay: 0 },
        { char: 'A', baseX: -1.0, splitDir: -1.3, delay: 0 },
        { char: 'L', baseX: -0.5, splitDir: -0.6, delay: 0 },
        { char: 'E', baseX: 0, splitDir: 0, delay: 0 },
        { char: 'E', baseX: 0.5, splitDir: 0.6, delay: 0 },
        { char: 'H', baseX: 1.0, splitDir: 1.3, delay: 0 },
        { char: 'A', baseX: 1.5, splitDir: 2.0, delay: 0 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of MALEEHA
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* MALEEHA Letters - Rubik Scribble font with fade-in animation */}
